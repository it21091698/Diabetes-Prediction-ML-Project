...
# FUNCTION
def user_report():
    age = st.sidebar.number_input('Age', min_value=3, max_value=88, value=33)
...
# Load your dataset
dataset = pd.read_csv('C:/Users/Ruhul Haq/Documents/4.1 Modules/ML Project/Diabetes Prediction/Diabetes-Prediction-Model-main/predict/diabetes_prediction_dataset.csv')
...
def horizontal_line():
    st.markdown('<hr style="border-top: 4px solid #009900;">', unsafe_allow_html=True)
# HEADINGS
...
st.markdown(f'<p style="color: #009900; font-size: 24px;">{output}</p>', unsafe_allow_html=True)
